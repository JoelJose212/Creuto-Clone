...
const TESTIMONIALS = [
  {
    ...
    description: "MoolSap delivered a web and mobile app that exceeded the client's expectations. The team was highly responsive and punctual from a workflow standpoint, and internal stakeholders praised the service provider's collaborative nature and agility.",
  ...
  },
  {
    ...
    description: "Thanks to MoolSap's work, the client could track their expenses and employees' daily work efficiency. The team delivered a system that could solve and monitor complaints, improving guest satisfaction. They communicated well through in-person meetings. Overall, the product exceeded expectations.",
    name: "Vishal Sharma",
  ...
  },
  {
    ...
    description: "MoolSap's work led to a 28% increase in customer engagement, a 41% reduction in manual tasks, a 23% faster response time, and a 48% improvement in data accuracy. The team managed the project well and delivered on time. Overall, the team was committed to understanding the client's business needs.",
    name: "Daniel Foster",
    role: "CEO, Edverise",
    link: "https://clutch.co/go-to-review/4e36163a-56d5-4ae3-8b30-4c4d31c329d1/349787"
  },
  {
    quote: "“MoolSap's team was always open to listening to our requirements and consistently came up with effective solutions.”",
    description: "MoolSap's custom-developed LMS's highly intuitive and user-friendly UI received positive user feedback upon implementation. The team was responsive and committed, ensuring that UX and educational needs were fulfilled, providing modules for assessments and quizzes, and communication and forum tools.",
    name: "Anonymous CEO",
    role: "CEO, Education Company",
    link: "https://clutch.co/go-to-review/4e36163a-56d5-4ae3-8b30-4c4d31c329d1/293451"
  },
  {
    quote: "“MoolSap treated us like friends and operated like internal team members. The process was fully transparent.”",
    description: "MoolSap developed a solid, bug-free mobile app that met the client's expectations. The team delivered items ahead of schedule, demonstrated reliability regarding MVP development, and operated like an in-house team, treating the client as friends and handling a fully transparent process.",
    name: "Anonymous Executive",
  ...
  },
  {
    ...
    description: "MoolSap Technologies delivered an intuitive, user-friendly solution that streamlined the client's processes, saving them valuable time and resources. Professional and attentive, they took the time to understand the client's needs and worked collaboratively to tailor a solution that matched.",
  ...
  {
    quote: "“What impressed us most about MoolSap was their deep understanding of both design and product thinking.”",
    description: "MoolSap's app led to increased user engagement and product adherence. Customers interacted with the brand daily, creating stronger and more consistent wellness habits. The team was smooth, structured, and highly responsive. They maintained clear communication and delivered items on time.",
    name: "Namrata Reddy",
    role: "CEO, Bloomally",
    link: "https://clutch.co/go-to-review/4e36163a-56d5-4ae3-8b30-4c4d31c329d1/384806"
  },
  {
    quote: "“What stood out the most about MoolSap was their exceptional UI/UX expertise.”",
    description: "MoolSap's work led to a significant increase in engagement, user interaction, and time spent on pages for the client. The team's project management, timely delivery, and receptiveness to feedback were commendable. Moreover, MoolSap's UI/UX expertise and thoughtful designs stood out.",
    name: "Rounak Mehra",
    role: "Co-Founder, Indus AI",
    link: "https://clutch.co/go-to-review/4e36163a-56d5-4ae3-8b30-4c4d31c329d1/383518"
  },
  {
    quote: "“Honestly, we had a smooth experience working with MoolSap.”",
    description: "MoolSap's system improved the client's donation management efficiency, reduced manual tracking, provided real-time fundraising insights, and decreased donor drop-offs. The team was supportive, communicative, and easy to work with. The team cared about building something meaningful for the client.",
    name: "Bidisha Roy",
  ...
  },
  {
    ...
    description: "MoolSap's work streamlined the client's processes, improved batch traceability, and made production planning more efficient, dropping manual paperwork by 80%. Moreover, the team managed the project smoothly, was timely, and communicated clearly. Overall, MoolSap's openness was impressive.",
    name: "Karan Verma",
  ...
  },
  {
    ...
    description: "Thanks to MoolSap's work, the client saw steady app growth in transactions and SIPs, full regulatory compliance, and positive user feedback. The team had excellent project management, delivered timely milestones, and communicated proactively. MoolSap's understanding of the client's industry stood out.",
    name: "Colton Wade",
    role: "CEO, Breuto",
    link: "https://clutch.co/go-to-review/4e36163a-56d5-4ae3-8b30-4c4d31c329d1/379506"
  },
  {
    quote: "“What impressed us most about MoolSap was their deep understanding of HR processes.”",
    description: "MoolSap's work cut the client's HR processing time by 40%, reduced payroll errors by 60%, and was adopted by 90% of the client's staff within the first month. The team demonstrated professionalism, deep domain knowledge, and a clear understanding of the client's requirements. They met all deadlines.",
