export const TESTIMONIALS = [
  {
    text: "Their services were excellent. MoolSap delivered a web and mobile app that exceeded expectations.",
  ...
  {
    text: "MoolSap's team was always open to listening and consistently came up with effective solutions for our custom LMS.",
    name: "Anonymous CEO",
